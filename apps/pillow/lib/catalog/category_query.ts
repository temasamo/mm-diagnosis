...
export const CATEGORY_QUERIES: Record<CategoryId, QuerySpec> = {
  ...
  "side-contour":    { primary: ["横向き 枕", "波型 枕", "サイドサポート 枕", "横向き専用 枕", "ウェーブ 枕"], tags: ["サイド高", "横向き", "波型", "サイドサポート"] },
  "back-contour":    { primary: ["頸椎 枕", "首 サポート 枕", "仰向け 枕", "バックサポート 枕", "頸椎サポート 枕"], tags: ["仰向け", "頸椎", "首サポート", "バックサポート"] },
