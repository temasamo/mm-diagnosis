...
export default function Page() {
  ...
  return (
    <main className="max-w-3xl mx-auto p-6 space-y-6">
      <div className="mb-6">
        <p className="text-gray-600 mb-2">{greet}</p>
        <h1 className="text-3xl font-bold text-gray-900">{APP_NAME}へようこそ</h1>
      </div>
      ...
      <section className="flex justify-between items-center mt-8">
        <a
          ...
          className="rounded-xl border border-gray-300 px-4 py-2 text-gray-600 transition-all hover:bg-gray-50"
        >
          ホームへ戻る
        </a>
        <div className="flex gap-3">
          ...
          <button
            onClick={reset}
            className="rounded-xl border border-gray-300 px-5 py-3 text-gray-600 transition-all hover:bg-gray-50"
          >
            リセット
          </button>
        </div>
